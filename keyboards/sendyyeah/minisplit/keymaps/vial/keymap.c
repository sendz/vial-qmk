...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_ortho(
      ...
      KC_LCTL,  KC_LALT,    KC_LALT, KC_LGUI, MO(_RAISE),   KC_SPC, KC_LBRC,   KC_RBRC,     KC_SPC,  MO(_RAISE),    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = LAYOUT_ortho(
      ...
      _______, _______, _______, _______, _______, _______, KC_MINS, KC_EQL, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY \
      ),
