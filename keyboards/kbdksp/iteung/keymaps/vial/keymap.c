...
[1] = LAYOUT(
  ...
  _______, _______, RGB_TOG, RGB_MOD, RGB_VAI, _______,                       KC_PGDN, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______,
  KC_CAPS, _______, _______, RGB_RMOD, RGB_VAD, _______, _______,       _______, _______, _______, _______, _______, _______, _______,
